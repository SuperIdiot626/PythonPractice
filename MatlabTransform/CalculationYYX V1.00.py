...
def GCGS(   n0=None,
    ...
    for m in range(0,n0 - 1):
        ...
        for p in range(0,n1 - 1):
            ...
            #将四个角点投影到面元平面上
            B2_tou[2* n1   * m   +p  ]=B1[2* n1   * m   +p  ] + N_B2_danwei[2*(n1-1)* m   +p  ]*(Average_B2[2*(n1-1)* m   +p  ] - B1[2* n1   * m   +p  ])
            B2_tou[2* n1   *(m+1)+p  ]=B1[2* n1   *(m+1)+p  ] + N_B2_danwei[2*(n1-1)* m   +p  ]*(Average_B2[2*(n1-1)* m   +p  ] - B1[2* n1   *(m+1)+p  ])
            B2_tou[2* n1   *(m+1)+p+1]=B1[2* n1   *(m+1)+p+1] + N_B2_danwei[2*(n1-1)* m   +p  ]*(Average_B2[2*(n1-1)* m   +p  ] - B1[2* n1   *(m+1)+p+1])
            B2_tou[2* n1   * m   +p+1]=B1[2* n1   * m   +p+1] + N_B2_danwei[2*(n1-1)* m   +p  ]*(Average_B2[2*(n1-1)* m   +p  ] - B1[2* n1   * m   +p+1])
        ...
        for p in range(n1,2*n1-1):
            ...
            #将四个角点投影到面元平面上
            B2_tou[2* n1   * m   +p  ]=B1[2* n1   * m   +p  ] + N_B2_danwei[2*(n1-1)* m   +p-1]*(Average_B2[2*(n1-1)* m   +p-1] - B1[2* n1   * m   +p  ])
            B2_tou[2* n1   *(m+1)+p  ]=B1[2* n1   *(m+1)+p  ] + N_B2_danwei[2*(n1-1)* m   +p-1]*(Average_B2[2*(n1-1)* m   +p-1] - B1[2* n1   *(m+1)+p  ])
            B2_tou[2* n1   *(m+1)+p+1]=B1[2* n1   *(m+1)+p+1] + N_B2_danwei[2*(n1-1)* m   +p-1]*(Average_B2[2*(n1-1)* m   +p-1] - B1[2* n1   *(m+1)+p+1])
            B2_tou[2* n1   * m   +p+1]=B1[2* n1   * m   +p+1] + N_B2_danwei[2*(n1-1)* m   +p-1]*(Average_B2[2*(n1-1)* m   +p-1] - B1[2* n1   * m   +p+1])
...
def writeexcel(data,name,dimension):
    try:
        wb=openpyxl.load_workbook('datacorrection.xlsx')    #打开名为...的excel文件
    except:
    ...
    if dimension==1:
        ...
        while i<row_num:
            ...
            i+=1
    wb.save('datacorrection.xlsx')                         #将创建的excel文档以此名称保存
