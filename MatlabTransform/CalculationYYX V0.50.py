...
def GCGS(   n0=None,
    ...
    for m in range(0,n0-1):
        ...
        for p in range(0,n1-1):                     #m横坐标向右，p横坐标向上为例
            ...
            N_B1_fanshu[2*(n1-1)* m   +p  ]=linalg.norm(N_B1[2*(n1-1)* m   +p  ])
            ...
            T1_up_fanshu[2*(n1-1)* m   +p  ]=linalg.norm(T1_up[2*(n1-1)* m   +p  ])
            ...
            #撞击角
            zhuangjijiao_up [2*(n1-1)* m   +p  ]=pi/2-arccos(-(dot(N_B1_danwei[2*(n1-1)* m   +p  ],V[0])))/ linalg.norm(V[0])
        ...
        for p in range(n1-1,2*n1-1):
            ...
            N_B1_fanshu[2*(n1-1)* m   +p-1]=linalg.norm(N_B1[2*(n1-1)* m   +p-1])
            ...
            T1_up_fanshu[2*(n1-1)* m   +p-1]=linalg.norm(T1_up[2*(n1-1)* m   +p-1])
            ...
            #撞击角
            zhuangjijiao_up [2*(n1-1)* m   +p-1]=pi/2-arccos(-(dot(N_B1_danwei[2*(n1-1)* m   +p-1],V[0])))/ linalg.norm(V[0])
    ...
    for m in range(0,n0 - 1):
        ...
        for p in range(0,n1 - 1):
            T1_down[2*(n1-1)* m   +p  ]=B2[2*(n1-1)* m   +p+1] - B2[2*(n1-1)* m   +p  ]
            T2_down[2*(n1-1)* m   +p  ]=B2[2*(n1-1)* m   +p+1] - B2[2*(n1-1)* m   +p  ]
            ...
            Average_B2[2*(n1-1)* m   +p  ]=multiply(0.25,(B2[2*(n1-1)* m   +p  ] + B2[2*(n1-1)* m   +p  ] + B2[2*(n1-1)* m   +p+1] + B2[2*(n1-1)* m   +p+1]))
            #????????????????????
            B2_tou[2* n1   * m   +p  ]=B2[2*(n1-1)* m   +p  ] + multiply((N_B2_danwei[2*(n1-1)* m   +p  ]),(Average_B2[2*(n1-1)* m   +p  ] - B2[2*(n1-1)* m   +p  ]))
            B2_tou[2* n1   *(m+1)+p  ]=B2[2*(n1-1)* m   +p  ] + multiply(N_B2_danwei[2*(n1-1)* m   +p  ],(Average_B2[2*(n1-1)* m   +p  ] - B2[2*(n1-1)* m   +p  ]))
            B2_tou[2* n1   *(m+1)+p+1]=B2[2*(n1-1)* m   +p+1] + multiply(N_B2_danwei[2*(n1-1)* m   +p  ],(Average_B2[2*(n1-1)* m   +p  ] - B2[2*(n1-1)* m   +p+1]))
            B2_tou[2* n1   * m   +p+1]=B2[2*(n1-1)* m   +p+1] + multiply(N_B2_danwei[2*(n1-1)* m   +p  ],(Average_B2[2*(n1-1)* m   +p  ] - B2[2*(n1-1)* m   +p+1]))
            #????????????:???��??X_bar??Y_bar??Z_bar??x???????t1,y???????m??z???????n
            ...
            #??????????????????????????????
            #x
            B2_myx[2* n1   * m   +p  ][0]=multiply(T1_down_danwei[2*(n1-1)* m   +p  ][0],(B2_tou[2* n1   * m   +p  ][0] - Average_B2[2*(n1-1)* m   +p  ][0])) + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p  ][1])) + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][2],(B2_tou[2* n1   * m   +p  ][2] - Average_B2[2*(n1-1)* m   +p  ][2]))
            B2_myx[2* n1   *(m+1)+p  ][1]=multiply(T1_down_danwei[2*(n1-1)* m   +p  ][0],(B2_tou[2* n1   *(m+1)+p  ][0] - Average_B2[2*(n1-1)* m   +p  ][0])) + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][1],(B2_tou[2* n1   *(m+1)+p  ][1] - Average_B2[2*(n1-1)* m   +p  ][1])) + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][2],(B2_tou[2* n1   *(m+1)+p  ][2] - Average_B2[2*(n1-1)* m   +p  ][2]))
            B2_myx[2* n1   *(m+1)+p+1][0]=multiply(T1_down_danwei[2*(n1-1)* m   +p  ][0],(B2_tou[2* n1   *(m+1)+p+1][0] - Average_B2[2*(n1-1)* m   +p  ][0])) + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][1],(B2_tou[2* n1   *(m+1)+p+1][1] - Average_B2[2*(n1-1)* m   +p  ][1])) + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][2],(B2_tou[2* n1   *(m+1)+p+1][2] - Average_B2[2*(n1-1)* m   +p  ][2]))
            B2_myx[2* n1   * m   +p+1][0]=multiply(T1_down_danwei[2*(n1-1)* m   +p  ][0],(B2_tou[2* n1   * m   +p+1][0] - Average_B2[2*(n1-1)* m   +p  ][0])) + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p  ][1])) + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][2],(B2_tou[2* n1   * m   +p+1][2] - Average_B2[2*(n1-1)* m   +p  ][2]))
            #y
            B2_myx[2* n1   * m   +p  ][1]=multiply(m_danwei_down[2*(n1-1)* m   +p  ][0],(B2_tou[2* n1   * m   +p  ][0] - Average_B2[2*(n1-1)* m   +p  ][0])) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p  ][1])) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][2],(B2_tou[2* n1   * m   +p  ][2] - Average_B2[2*(n1-1)* m   +p  ][2]))
            B2_myx[2* n1   *(m+1)+p  ][1]=multiply(m_danwei_down[2*(n1-1)* m   +p  ][0],(B2_tou[2* n1   *(m+1)+p  ][0] - Average_B2[2*(n1-1)* m   +p  ][0])) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][1],(B2_tou[2* n1   *(m+1)+p  ][1] - Average_B2[2*(n1-1)* m   +p  ][1])) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][2],(B2_tou[2* n1   *(m+1)+p  ][2] - Average_B2[2*(n1-1)* m   +p  ][2]))
            B2_myx[2* n1   *(m+1)+p+1][1]=multiply(m_danwei_down[2*(n1-1)* m   +p  ][0],(B2_tou[2* n1   *(m+1)+p+1][0] - Average_B2[2*(n1-1)* m   +p  ][0])) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][1],(B2_tou[2* n1   *(m+1)+p+1][1] - Average_B2[2*(n1-1)* m   +p  ][1])) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][2],(B2_tou[2* n1   *(m+1)+p+1][2] - Average_B2[2*(n1-1)* m   +p  ][2]))
            B2_myx[2* n1   * m   +p+1][1]=multiply(m_danwei_down[2*(n1-1)* m   +p  ][0],(B2_tou[2* n1   * m   +p+1][0] - Average_B2[2*(n1-1)* m   +p  ][0])) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p  ][1])) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][2],(B2_tou[2* n1   * m   +p+1][2] - Average_B2[2*(n1-1)* m   +p  ][2]))
            #z
            B2_myx[2* n1   * m   +p  ][2]=0
            ...
            #????????????A
            A_down[2*(n1-1)* m   +p  ][0]=multiply(multiply(0.5,(B2_myx[2* n1   *(m+1)+p+1][0] - B2_myx[2* n1   * m   +p  ][0])),(B2_myx[2* n1   *(m+1)+p  ][0] - B2_myx[2* n1   * m   +p+1][0]))
            ZhiXin_down[2*(n1-1)* m   +p  ][0]=multiply(multiply((1 / 3),(1.0 / (B2_myx[2* n1   *(m+1)+p  ][1] - B2_myx[2* n1   * m   +p+1][1]))),(multiply(B2_myx[2* n1   * m   +p+1][0],(B2_myx[2* n1   * m   +p+1][1] - B2_myx[2* n1   *(m+1)+p  ][1])) + multiply(B2_myx[2* n1   *(m+1)+p  ][0],(B2_myx[2* n1   * m   +p+1][1] - B2_myx[2* n1   * m   +p+1][1]))))
            ZhiXin_down[2*(n1-1)* m   +p  ][1]=multiply((- 1 / 3),B2_myx[2* n1   * m   +p+1][1])
            ZhiXin_down[2*(n1-1)* m   +p  ][2]=0
            Zhixin_down_fxqzbx[2*(n1-1)* m   +p  ][0]=Average_B2[2*(n1-1)* m   +p  ][0] + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][0],ZhiXin_down[2*(n1-1)* m   +p  ][0]) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][0],ZhiXin_down[2*(n1-1)* m   +p  ][1])
            Zhixin_down_fxqzbx[2*(n1-1)* m   +p  ][1]=Average_B2[2*(n1-1)* m   +p  ][1] + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][1],ZhiXin_down[2*(n1-1)* m   +p  ][0]) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][1],ZhiXin_down[2*(n1-1)* m   +p  ][1])
            Zhixin_down_fxqzbx[2*(n1-1)* m   +p  ][2]=Average_B2[2*(n1-1)* m   +p  ][2] + multiply(T1_down_danwei[2*(n1-1)* m   +p  ][2],ZhiXin_down[2*(n1-1)* m   +p  ][0]) + multiply(m_danwei_down[2*(n1-1)* m   +p  ][2],ZhiXin_down[2*(n1-1)* m   +p  ][1])
            zhuangjijiao_down[2*(n1-1)* m   +p  ][0]=pi / 2 - arccos((- (dot(N_B2_danwei[2*(n1-1)* m   +p  ][0],V(1,range())))) / (norm(V(1,range()))))
            if zhuangjijiao_down[2*(n1-1)* m   +p  ][0] >= 0:
                Cp_down[2*(n1-1)* m   +p  ][0]=Newton1(zhuangjijiao_down[2*(n1-1)* m   +p  ][0],V[0][0],V[0][1],V[0][2],Ma)
            if zhuangjijiao_down[2*(n1-1)* m   +p  ][0] < 0:
                Cp_down[2*(n1-1)* m   +p  ][0]=Qie2(zhuangjijiao_down[2*(n1-1)* m   +p  ][0],V[0][0],V[0][1],V[0][2],Ma)
            #????????
            F_down[2*(n1-1)* m   +p  ][0]=multiply(A_down[2*(n1-1)* m   +p  ][0],(multiply(multiply(multiply(Cp_down[2*(n1-1)* m   +p  ][0],0.5),midu),(V[0][0]**2+V[0][1]**2+V[0][2]**2)) +p_lailiu))
            CA_down[2*(n1-1)* m   +p  ][0]=multiply(F_down[2*(n1-1)* m   +p  ][0],N_B1_danwei[2*(n1-1)* m   +p  ][0]) / (0.5*midu*(V[0][0]**2+V[0][1]**2+V[0][2]**2)*S_can)
            CN_down[2*(n1-1)* m   +p  ][0]=multiply(F_down[2*(n1-1)* m   +p  ][0],N_B1_danwei[2*(n1-1)* m   +p  ][2]) / (0.5*midu*(V[0][0]**2+V[0][1]**2+V[0][2]**2)*S_can)
            CZ_down[2*(n1-1)* m   +p  ][0]=multiply(F_down[2*(n1-1)* m   +p  ][0],N_B1_danwei[2*(n1-1)* m   +p  ][1]) / (0.5*midu*(V[0][0]**2+V[0][1]**2+V[0][2]**2)*S_can)
            Cl_down[2*(n1-1)* m   +p  ][0]=multiply(CN_down[2*(n1-1)* m   +p  ][0],cos(AttackAngle)) - multiply(CA_down[2*(n1-1)* m   +p  ][0],sin(AttackAngle))
            Cd_down[2*(n1-1)* m   +p  ][0]=multiply(CN_down[2*(n1-1)* m   +p  ][0],sin(AttackAngle)) + multiply(CA_down[2*(n1-1)* m   +p  ][0],cos(AttackAngle))
        # test.m:482
        ####################??????####################
        ####################???####################
        for p in range((n1 + 1),(dot(2,n1) - 1)).reshape(-1):
            T1_down[2*(n1-1)* m   +p-1]=B2[2*(n1-1)* m   +p+1][0] - B2[2*(n1-1)* m   +p  ][0]
            T2_down[2*(n1-1)* m   +p-1]=B2[2*(n1-1)* m   +p+1][0] - B2[2*(n1-1)* m   +p  ][0]
            N_B2[2*(n1-1)* m   +p-1]=cross(T2_down[2*(n1-1)* m   +p-1],T1_down[2*(n1-1)* m   +p-1])
            N_B2_fanshu[2*(n1-1)* m   +p-1]=norm(N_B2[2*(n1-1)* m   +p-1])
            N_B2_danwei[2*(n1-1)* m   +p-1]=- (N_B2[2*(n1-1)* m   +p-1]) / (N_B2_fanshu[2*(n1-1)* m   +p-1])
            Average_B2[2*(n1-1)* m   +p-1]=multiply(0.25,(B2[2*(n1-1)* m   +p  ][0] + B2[2*(n1-1)* m   +p  ][0] + B2[2*(n1-1)* m   +p+1][0] + B2[2*(n1-1)* m   +p+1][0]))
            #????????????????????
            B2_tou[2* n1   * m   +p  ]=B2[2*(n1-1)* m   +p  ][0] + multiply(N_B2_danwei[2*(n1-1)* m   +p-1],(Average_B2[2*(n1-1)* m   +p-1] - B2[2*(n1-1)* m   +p  ][0]))
            B2_tou[2* n1   *(m+1)+p  ]=B2[2*(n1-1)* m   +p  ][0] + multiply(N_B2_danwei[2*(n1-1)* m   +p-1],(Average_B2[2*(n1-1)* m   +p-1] - B2[2*(n1-1)* m   +p  ][0]))
            B2_tou[2* n1   *(m+1)+p+1]=B2[2*(n1-1)* m   +p+1][0] + multiply(N_B2_danwei[2*(n1-1)* m   +p-1],(Average_B2[2*(n1-1)* m   +p-1] - B2[2*(n1-1)* m   +p+1][0]))
            B2_tou[2* n1   * m   +p+1]=B2[2*(n1-1)* m   +p+1][0] + multiply(N_B2_danwei[2*(n1-1)* m   +p-1],(Average_B2[2*(n1-1)* m   +p-1] - B2[2*(n1-1)* m   +p+1][0]))
            #????????????:???��??X_bar??Y_bar??Z_bar??x???????t1_down,y???????m??z???????n
            T1_down_fanshu[2*(n1-1)* m   +p-1]=norm(T1_down[2*(n1-1)* m   +p-1])
            T1_down_danwei[2*(n1-1)* m   +p-1]=T1_down[2*(n1-1)* m   +p-1] / T1_down_fanshu[2*(n1-1)* m   +p-1]
            m_danwei_down[2*(n1-1)* m   +p-1]=cross(N_B2_danwei[2*(n1-1)* m   +p-1],T1_down_danwei[2*(n1-1)* m   +p-1])
            #??????????????????????????????
       #x
            B2_myx[2* n1   * m   +p  ][0]=multiply(T1_down_danwei[2*(n1-1)* m   +p-1][0],(B2_tou[2* n1   * m   +p  ][0] - Average_B2[2*(n1-1)* m   +p-1][0])) + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p-1][1])) + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][2],(B2_tou[2* n1   * m   +p  ][2] - Average_B2[2*(n1-1)* m   +p-1][2]))
            B2_myx[2* n1   *(m+1)+p  ][1]=multiply(T1_down_danwei[2*(n1-1)* m   +p-1][0],(B2_tou[2* n1   * m   +p  ][0] - Average_B2[2*(n1-1)* m   +p-1][0])) + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p-1][1])) + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][2],(B2_tou[2* n1   * m   +p  ][2] - Average_B2[2*(n1-1)* m   +p-1][2]))
            B2_myx[2* n1   *(m+1)+p+1][0]=multiply(T1_down_danwei[2*(n1-1)* m   +p-1][0],(B2_tou[2* n1   *(m+1)+p+1][0] - Average_B2[2*(n1-1)* m   +p-1][0])) + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][1],(B2_tou[2* n1   *(m+1)+p+1][1] - Average_B2[2*(n1-1)* m   +p-1][1])) + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][2],(B2_tou[2* n1   *(m+1)+p+1][2] - Average_B2[2*(n1-1)* m   +p-1][2]))
            B2_myx[2* n1   * m   +p+1][0]=multiply(T1_down_danwei[2*(n1-1)* m   +p-1][0],(B2_tou[2* n1   * m   +p+1][0] - Average_B2[2*(n1-1)* m   +p-1][0])) + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p-1][1])) + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][2],(B2_tou[2* n1   * m   +p+1][2] - Average_B2[2*(n1-1)* m   +p-1][2]))
            #y
            B2_myx[2* n1   * m   +p  ][1]=multiply(m_danwei_down[2*(n1-1)* m   +p-1][0],(B2_tou[2* n1   * m   +p  ][0] - Average_B2[2*(n1-1)* m   +p-1][0])) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p-1][1])) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][2],(B2_tou[2* n1   * m   +p  ][2] - Average_B2[2*(n1-1)* m   +p-1][2]))
            B2_myx[2* n1   *(m+1)+p  ][1]=multiply(m_danwei_down[2*(n1-1)* m   +p-1][0],(B2_tou[2* n1   * m   +p  ][0] - Average_B2[2*(n1-1)* m   +p-1][0])) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p-1][1])) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][2],(B2_tou[2* n1   * m   +p  ][2] - Average_B2[2*(n1-1)* m   +p-1][2]))
            B2_myx[2* n1   *(m+1)+p+1][1]=multiply(m_danwei_down[2*(n1-1)* m   +p-1][0],(B2_tou[2* n1   *(m+1)+p+1][0] - Average_B2[2*(n1-1)* m   +p-1][0])) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][1],(B2_tou[2* n1   *(m+1)+p+1][1] - Average_B2[2*(n1-1)* m   +p-1][1])) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][2],(B2_tou[2* n1   *(m+1)+p+1][2] - Average_B2[2*(n1-1)* m   +p-1][2]))
            B2_myx[2* n1   * m   +p+1][1]=multiply(m_danwei_down[2*(n1-1)* m   +p-1][0],(B2_tou[2* n1   * m   +p+1][0] - Average_B2[2*(n1-1)* m   +p-1][0])) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][1],(B2_tou[2* n1   * m   +p+1][1] - Average_B2[2*(n1-1)* m   +p-1][1])) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][2],(B2_tou[2* n1   * m   +p+1][2] - Average_B2[2*(n1-1)* m   +p-1][2]))
            #z
            B2_myx[2* n1   * m   +p  ][2]=0
            B2_myx[2* n1   *(m+1)+p  ][2]=0
            B2_myx[2* n1   *(m+1)+p+1][2]=0
            B2_myx[2* n1   * m   +p+1][2]=0
            #????????????A
            A_down[2*(n1-1)* m   +p-1]=multiply(multiply(0.5,(B2_myx[2* n1   *(m+1)+p+1][0] - B2_myx[2* n1   * m   +p  ][0])),(B2_myx[2* n1   *(m+1)+p  ][0] - B2_myx[2* n1   * m   +p+1][0]))
            ZhiXin_down[2*(n1-1)* m   +p-1][0]=multiply(multiply((1 / 3),(1.0 / (B2_myx[2* n1   *(m+1)+p  ][1] - B2_myx[2* n1   * m   +p+1][1]))),(multiply(B2_myx[2* n1   * m   +p+1][0],(B2_myx[2* n1   * m   +p+1][1] - B2_myx[2* n1   *(m+1)+p  ][1])) + multiply(B2_myx[2* n1   *(m+1)+p  ][0],(B2_myx[2* n1   * m   +p+1][1] - B2_myx[2* n1   * m   +p+1][1]))))
            ZhiXin_down[2*(n1-1)* m   +p-1][1]=multiply(- (1 / 3),B2_myx[2* n1   * m   +p+1][1])
            ZhiXin_down[2*(n1-1)* m   +p-1][1]=0
            Zhixin_down_fxqzbx[2*(n1-1)* m   +p-1][0]=Average_B2[2*(n1-1)* m   +p-1][0] + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][0],ZhiXin_down[2*(n1-1)* m   +p-1][0]) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][0],ZhiXin_down[2*(n1-1)* m   +p-1][1])
            Zhixin_down_fxqzbx[2*(n1-1)* m   +p-1][1]=Average_B2[2*(n1-1)* m   +p-1][1] + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][1],ZhiXin_down[2*(n1-1)* m   +p-1][0]) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][1],ZhiXin_down[2*(n1-1)* m   +p-1][1])
            Zhixin_down_fxqzbx[2*(n1-1)* m   +p-1][2]=Average_B2[2*(n1-1)* m   +p-1][2] + multiply(T1_down_danwei[2*(n1-1)* m   +p-1][2],ZhiXin_down[2*(n1-1)* m   +p-1][0]) + multiply(m_danwei_down[2*(n1-1)* m   +p-1][2],ZhiXin_down[2*(n1-1)* m   +p-1][1])
            zhuangjijiao_down[2*(n1-1)* m   +p-1]=pi / 2 - arccos((- (dot(N_B2_danwei[2*(n1-1)* m   +p-1],V(1,range())))) / (norm(V(1,range()))))
            if zhuangjijiao_down[2*(n1-1)* m   +p-1] >= 0:
                Cp_down[2*(n1-1)* m   +p-1]=Newton1(zhuangjijiao_down[2*(n1-1)* m   +p-1],V[0][0],V[0][1],V[0][2],Ma)
            if zhuangjijiao_down[2*(n1-1)* m   +p-1] < 0:
                Cp_down[2*(n1-1)* m   +p-1]=Newton1(zhuangjijiao_down[2*(n1-1)* m   +p-1],V[0][0],V[0][1],V[0][2],Ma)
            #????????
            F_down[2*(n1-1)* m   +p-1]=multiply(A_down[2*(n1-1)* m   +p-1],(multiply(multiply(multiply(Cp_down[2*(n1-1)* m   +p-1],0.5),midu),(V[0][0]**2+V[0][1]**2+V[0][2]**2)) +p_lailiu))

            CA_down[2*(n1-1)* m   +p-1]=multiply(F_down[2*(n1-1)* m   +p-1],N_B1_danwei[2*(n1-1)* m   +p-1][0]) / (0.5*midu*(V[0][0]**2+V[0][1]**2+V[0][2]**2)*S_can)
            CN_down[2*(n1-1)* m   +p-1]=multiply(F_down[2*(n1-1)* m   +p-1],N_B1_danwei[2*(n1-1)* m   +p-1][2]) / (0.5*midu*(V[0][0]**2+V[0][1]**2+V[0][2]**2)*S_can)
            CZ_down[2*(n1-1)* m   +p-1]=multiply(F_down[2*(n1-1)* m   +p-1],N_B1_danwei[2*(n1-1)* m   +p-1][1]) / (0.5*midu*(V[0][0]**2+V[0][1]**2+V[0][2]**2)*S_can)
            Cl_down[2*(n1-1)* m   +p-1]=multiply(CN_down[2*(n1-1)* m   +p-1],cos(AttackAngle)) - multiply(CA_down[2*(n1-1)* m   +p-1],sin(AttackAngle))
            Cd_down[2*(n1-1)* m   +p-1]=multiply(CN_down[2*(n1-1)* m   +p-1],sin(AttackAngle)) + multiply(CA_down[2*(n1-1)* m   +p-1],cos(AttackAngle))
        ####################???????####################
