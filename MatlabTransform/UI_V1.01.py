...
dir_input=os.getcwd()
#print((dir_input))
#print(type(dir_input))
os.path.join(dir_input,'Input.txt')
dir_input='asdasdasdasdasdasdasd'
...
button_Calcu          .place(width=250,height=50,x=100,y=780)
button_Analys         .place(width=250,height=50,x=550,y=780)
