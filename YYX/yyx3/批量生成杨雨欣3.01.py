...
import os 
import time
stringPart1=r'''# Pointwise V18.3 Journal file - Fri Jul  2 16:22:12 2021
...
ChangedP1_01='  $_TMP(mode_1) initialize -strict -type Automatic E:/CST/Part1/Data/'


stringPart2=r'''  $_TMP(mode_1) read
  $_TMP(mode_1) convert
$_TMP(mode_1) end
unset _TMP(mode_1)
...
ChangedP2_01='pw::Application save E:/CST/Part1/Data/'


stringPart3=r'''set _TMP(mode_1) [pw::Application begin CaeExport [pw::Entity sort [list $_BL(1)]]]
'''
ChangedP3_01='  $_TMP(mode_1) initialize -strict -type CAE E:/CST/Part1/Data/'

stringPart4=r'''  $_TMP(mode_1) verify
  $_TMP(mode_1) write
$_TMP(mode_1) end
unset _TMP(mode_1)
'''
...
while(i<=768):
    file=open(str(i)+'.glf','w')
    #print('file name is '+str(i)+'.glf')
    print('Creating Grid File%d'%i)
    #time.sleep(0.01)
    if i%10==0:
        timeNow=time.time()
        print('Time used: %dms'%((timeNow-timeStarted)*1000))

    file.write(stringPart1)
    file.write(ChangedP1_01+str(i)+'/'+str(i)+'.igs\n')
    file.write(stringPart2)
    file.write(ChangedP2_01+str(i)+'/'+str(i)+'.pw\n')
    file.write(stringPart3)
    file.write(ChangedP3_01+str(i)+'\n')
    file.write(stringPart4)
    i=i+1
    file.close()
a=input('All Grid-Files Created Successful!')
