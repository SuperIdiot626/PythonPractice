...
def create4ball():
    ball=Planet(400,200,50,0,(255,255,0),200,1)
    ball=Planet(400,600,-50,0,(255,0,255),200,2)
    ...
    for event in pygame.event.get():
        ...
        if event.type==KEYDOWN:
            ...
            if event.key==K_b:                       # B开启最大质量星球跟踪
                center=999                           # 这里随便设置了一个数字，只要比总星球数多即可
