...
import os 
stringPart1=r'''# Pointwise V18.0R2 Journal file - Sun Jun 27 14:32:31 2021
...
ChangedP1_01='  $_TMP(mode_1) initialize -type Automatic {E:/CST/Part1/Data/'
...
stringPart3=r'''set _TMP(exam_1) [pw::Examine create BlockMaximumAngle]
...
'''
ChangedP3_01='  $_TMP(mode_5) initialize -type CAE {E:/CST/Part1/Data/'

stringPart4=r'''  if {![$_TMP(mode_5) verify]} {
