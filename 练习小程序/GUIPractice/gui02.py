...
class MY_GUI():
    ...
    def set_init_window(self):
        ...
        #self.init_window_name.geometry('320x160+10+10')                            #290 160为窗口大小，此项会受系统放大倍率影响，+10 +10 定义窗口弹出时的默认展示位置
        self.init_window_name.geometry('800x400+100+100')
        self.init_window_name["bg"] = "pink"                                        #窗口背景色，其他背景色见：blog.csdn.net/chl0000/article/details/7657887
        self.init_window_name.attributes("-alpha",0.90)                             #透明度，值越小透明程度越高
