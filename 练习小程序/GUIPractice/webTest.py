...
ctrl_aver= tk.Checkbutton(window,text='average' ,variable=var_pri_avera,    onvalue=1, offvalue=0,command=print_selection)
ctrl_gap = tk.Checkbutton(window,text='gap step',variable=var_pri_gap,      onvalue=1, offvalue=0,command=print_selection)
ctrl_dir = tk.Checkbutton(window,text='dir     ',variable=var_pri_dir,      onvalue=1, offvalue=0,command=print_selection)
ctrl_step= tk.Checkbutton(window,text='step   ',variable=var_pri_steps,     onvalue=1, offvalue=0,command=print_selection)
ctrl_time= tk.Checkbutton(window,text='time',   variable=var_pri_time,      onvalue=1, offvalue=0,command=print_selection)
ctrl_Fx  = tk.Checkbutton(window,text='Fx',     variable=var_pri_Fx,      onvalue=1, offvalue=0,command=print_selection)
ctrl_Fy  = tk.Checkbutton(window,text='Fy',     variable=var_pri_Fy,        onvalue=1, offvalue=0,command=print_selection)
ctrl_Fz  = tk.Checkbutton(window,text='Fz',     variable=var_pri_Fz,        onvalue=1, offvalue=0,command=print_selection)
ctrl_Mx  = tk.Checkbutton(window,text='Mx',     variable=var_pri_Mx,        onvalue=1, offvalue=0,command=print_selection)
ctrl_My  = tk.Checkbutton(window,text='My',     variable=var_pri_My,        onvalue=1, offvalue=0,command=print_selection)
ctrl_Mz  = tk.Checkbutton(window,text='Mz',     variable=var_pri_Mz,        onvalue=1, offvalue=0,command=print_selection)
ctrl_LC  = tk.Checkbutton(window,text='LiftCoe',variable=var_pri_LiftCoe,   onvalue=1, offvalue=0,command=print_selection)
ctrl_DC  = tk.Checkbutton(window,text='DragCoe',variable=var_pri_DragCoe,   onvalue=1, offvalue=0,command=print_selection)
ctrl_LDR = tk.Checkbutton(window,text='L-G Coe',variable=var_pri_LD_ratio,  onvalue=1, offvalue=0,command=print_selection)
...
ave_entry.grid(row=4,column=1,columnspan=1,sticky='E')

ctrl_gap .grid(row=5,column=0,columnspan=1)
gap_entry.grid(row=5,column=1,columnspan=1,sticky='E')
...
ctrl_Mx  .grid(row=7,column=1,columnspan=1,)

ctrl_Fy  .grid(row=8,column=0,columnspan=1,sticky='E')
ctrl_My  .grid(row=8,column=1,columnspan=1,)

ctrl_Fz  .grid(row=9,column=0,columnspan=1.5,sticky='E')
ctrl_Mz  .grid(row=9,column=1,columnspan=1,)
